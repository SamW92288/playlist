...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:default@localhost/playlist-app"

app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SQLALCHEMY_ECHO'] = True

#conn = psycopg2.connect(database="playlist-app", user="postgres", 
 #                       password="default", host="localhost", port="5432")
...
def add_playlist():
    ...
    if form.validate_on_submit():
        try:
            ...
            i = Playlist(name=form.name.data, description=form.description.data)
            db.session.add(i)
            db.session.commit()
